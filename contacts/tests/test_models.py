...
class TestContactModel(TestCase):
    ...
    def test_duplicate_email_fails(self):
        TestContact.objects.create(name="John", email="john@unilink.com")
        with self.assertRaises(IntegrityError):
            TestContact.objects.create(name="Jane", email="john@unilink.com")

    def test_blank_email_fails(self):
        contact = TestContact(name="John", email="")
...
class TestPhoneNumber(TestCase):
    ...
    def test_can_create_same_type_on_different_contacts(self):
        contact1 = TestContact.objects.create(name="John", email="john@unilink.com")
        contact2 = TestContact.objects.create(name="Alice", email="alice@unilink.com")
    ...
    def test_phone_number_str_representation(self):
        contact = TestContact.objects.create(name="Bob", email="bob@unilink.com")
